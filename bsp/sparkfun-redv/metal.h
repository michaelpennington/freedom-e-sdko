...
#ifndef MACROS_IF___HOME__KIRK__DEV__RISCV__FREEDOM_E_SDK__BSP__SPARKFUN_REDV__METAL_H
#define MACROS_IF___HOME__KIRK__DEV__RISCV__FREEDOM_E_SDK__BSP__SPARKFUN_REDV__METAL_H
...
#endif /* MACROS_IF___HOME__KIRK__DEV__RISCV__FREEDOM_E_SDK__BSP__SPARKFUN_REDV__METAL_H*/

#else /* ! __METAL_MACHINE_MACROS */

#ifndef MACROS_ELSE___HOME__KIRK__DEV__RISCV__FREEDOM_E_SDK__BSP__SPARKFUN_REDV__METAL_H
#define MACROS_ELSE___HOME__KIRK__DEV__RISCV__FREEDOM_E_SDK__BSP__SPARKFUN_REDV__METAL_H
...
#define __METAL_GPIO_10012000_INTERRUPTS 33

#define METAL_MAX_GPIO_INTERRUPTS 33
...
static __inline__ int __metal_driver_sifive_gpio0_interrupt_lines(struct metal_gpio *gpio, int idx)
{
	...
	else if ((((uintptr_t)gpio == (uintptr_t)&__metal_dt_gpio_10012000) && (idx == 32))) {
		return 29;
	}
	else {
		return 0;
...
#endif /* MACROS_ELSE___HOME__KIRK__DEV__RISCV__FREEDOM_E_SDK__BSP__SPARKFUN_REDV__METAL_H*/
